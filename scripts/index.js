...
const displayVideos = (videos) => {
    ...
    if (videos.length==0){
        ...
        <div class="col-span-full py-20 justify-center items-center text-center flex flex-col">
        ...
        <div class="card bg-base-100 ">
            ...
            <div class=" flex gap-3 px-0 py-5 ">
                ...
                <div class="card-intro">
                    ...
                    ${video.authors[0].verified==true ? `<img class="w-5 h-5" src="https://img.icons8.com/?size=96&id=T56b3Zn40UkH&format=png" alt="">` :
                        ``
                    } 
                    </p>
